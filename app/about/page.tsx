  ...
  return (
    <main className="min-h-screen bg-[#F3EDE5] text-[#2d4a47]">
      <section className="mx-auto max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="mb-10">
          <p className="text-xs sm:text-sm font-semibold uppercase tracking-[0.18em] text-[#2d4a47]/80 font-askha">About Us</p>
        ...
        <div className="space-y-10 text-base leading-relaxed text-[#2d4a47] sm:text-lg font-marcellus">
          <p>
            At TVIS, we believe that true transformation begins with a return to clarity. Our work is rooted in compassion, deep listening, and a commitment to helping you
            reconnect with your inner wisdom.
          </p>

          <p>
            Over the years, we&apos;ve guided individuals through seasons of transition, emotional healing, and spiritual growth. Every session, program, and resource we create is
            designed to gently illuminate the path forward so you can move with more confidence, peace, and authenticity.
          </p>

          <p>
            We honor your story, your pace, and your unique needs. This isn&apos;t about fixing you—it&apos;s about walking alongside you as you remember who you really are and
